...
void CServerDisplayer::SetWindowName() // OK
{
	...
	wsprintf(buff,"[%s] RoxGaming JoinServer (QueueSize : %d) (AccountCount : %d/%d)",JOINSERVER_VERSION,gSocketManager.GetQueueSize(),gAccountManager.GetAccountCount(),MAX_ACCOUNT);
