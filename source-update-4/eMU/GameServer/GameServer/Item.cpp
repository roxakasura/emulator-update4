...
BOOL CItem::IsWingOpGetOnePercentDamage()
{
	...
	if (this->m_Index >= GET_ITEM(12, 3) && this->m_Index <= GET_ITEM(12, 6) || this->m_Index == GET_ITEM(13, 30) || this->m_Index == GET_ITEM(12, 200))
	{
		if ((this->m_NewOption & 4) != 0)
		{
			return 3;
...
{
	if (this->m_Index >= GET_ITEM(12, 36) && this->m_Index <= GET_ITEM(12, 200))
	{
		if (this->m_Durability < 1.0f)
		{
			return 0;
...
{
	if ((this->m_Index >= GET_ITEM(6, 0)) && (this->m_Index < GET_ITEM(7, 0)))
	{
		return 0;
	}
