...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gGoldenArcher.Load(gPath.GetFullPath("Custom\\CustomGoldenArcher.txt"));
	#endif
...
#if(GAMESERVER_CLIENTE_UPDATE > 3)
	gItemNewOption.Load(gPath.GetFullPath("Item\\ItemNewOption.txt"));
#endif
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	#if(GAMESERVER_CLIENTE_UPDATE > 3)
	gNpcTalkMessagek.Load(gPath.GetFullPath("Monster\\NpcTalk.txt"));
	#endif
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandClearInventorySwitch[0] = GetPrivateProfileInt(section,"CommandClearInventoryEnable_AL0",0,path);

	this->m_CommandClearInventorySwitch[1] = GetPrivateProfileInt(section,"CommandClearInventoryEnable_AL1",0,path);

	this->m_CommandClearInventorySwitch[2] = GetPrivateProfileInt(section,"CommandClearInventoryEnable_AL2",0,path);

	this->m_CommandClearInventorySwitch[3] = GetPrivateProfileInt(section,"CommandClearInventoryEnable_AL3",0,path);

	GetPrivateProfileString(section,"CommandClearInventorySyntax","",this->m_CommandClearInvSyntax,sizeof(this->m_CommandClearInvSyntax),path);
	
	GetPrivateProfileString(section,"CommandMoveSyntax","",this->m_CommandMoveSyntax,sizeof(this->m_CommandMoveSyntax),path);
	
	GetPrivateProfileString(section,"CommandPostSyntax","",this->m_CommandPostSyntax,sizeof(this->m_CommandPostSyntax),path);
	
	GetPrivateProfileString(section,"CommandAddPointStrenghtSyntax","",this->m_CommandAddPointStrenghtSyntax,sizeof(this->m_CommandAddPointStrenghtSyntax),path);
	
	GetPrivateProfileString(section,"CommandAddPointAgilitySyntax","",this->m_CommandAddPointAgilitySyntax,sizeof(this->m_CommandAddPointAgilitySyntax),path);
		
	GetPrivateProfileString(section,"CommandAddPointVitalitySyntax","",this->m_CommandAddPointVitalitySyntax,sizeof(this->m_CommandAddPointVitalitySyntax),path);
	
	GetPrivateProfileString(section,"CommandAddPointEnergySyntax","",this->m_CommandAddPointEnergySyntax,sizeof(this->m_CommandAddPointEnergySyntax),path);
	
	GetPrivateProfileString(section,"CommandAddPointCommandSyntax","",this->m_CommandAddPointCommandSyntax,sizeof(this->m_CommandAddPointCommandSyntax),path);
	
	GetPrivateProfileString(section,"CommandPKClearSyntax","",this->m_CommandPKClearSyntax,sizeof(this->m_CommandPKClearSyntax),path);

	GetPrivateProfileString(section,"CommandMoneySyntax","",this->m_CommandMoneySyntax,sizeof(this->m_CommandMoneySyntax),path);

	GetPrivateProfileString(section,"CommandChangeSyntax","",this->m_CommandChangeSyntax,sizeof(this->m_CommandChangeSyntax),path);

	GetPrivateProfileString(section,"CommandWareSyntax","",this->m_CommandWareSyntax,sizeof(this->m_CommandWareSyntax),path);

	GetPrivateProfileString(section,"CommandResetSyntax","",this->m_CommandResetSyntax,sizeof(this->m_CommandResetSyntax),path);

	GetPrivateProfileString(section,"CommandMasterResetSyntax","",this->m_CommandMasterResetSyntax,sizeof(this->m_CommandMasterResetSyntax),path);
	
	GetPrivateProfileString(section,"CommandGMMoveSyntax","",this->m_CommandGMMoveSyntax,sizeof(this->m_CommandGMMoveSyntax),path);

	GetPrivateProfileString(section,"CommandGMPostSyntax","",this->m_CommandGMPostSyntax,sizeof(this->m_CommandGMPostSyntax),path);

	GetPrivateProfileString(section,"CommandTrackSyntax","",this->m_CommandTrackSyntax,sizeof(this->m_CommandTrackSyntax),path);

	GetPrivateProfileString(section,"CommandTraceSyntax","",this->m_CommandTraceSyntax,sizeof(this->m_CommandTraceSyntax),path);

	GetPrivateProfileString(section,"CommandDisconnectSyntax","",this->m_CommandDisconnectSyntax,sizeof(this->m_CommandDisconnectSyntax),path);

	GetPrivateProfileString(section,"CommandFireworksSyntax","",this->m_CommandFireworksSyntax,sizeof(this->m_CommandFireworksSyntax),path);

	GetPrivateProfileString(section,"CommandMakeSyntax","",this->m_CommandMakeSyntax,sizeof(this->m_CommandMakeSyntax),path);

	GetPrivateProfileString(section,"CommandSkinSyntax","",this->m_CommandSkinSyntax,sizeof(this->m_CommandSkinSyntax),path);

	GetPrivateProfileString(section,"CommandSetMoneySyntax","",this->m_CommandSetMoneySyntax,sizeof(this->m_CommandSetMoneySyntax),path);
	
	GetPrivateProfileString(section,"CommandNoticeSyntax","",this->m_CommandNoticeSyntax,sizeof(this->m_CommandNoticeSyntax),path);

	GetPrivateProfileString(section,"CommandHideSyntax","",this->m_CommandHideSyntax,sizeof(this->m_CommandHideSyntax),path);
	...
	this->m_CommandRequestSwitch[2] = GetPrivateProfileInt(section,"CommandRequestAutoEnable_AL2",0,path);

	this->m_CommandRequestSwitch[3] = GetPrivateProfileInt(section,"CommandRequestAutoEnable_AL3",0,path);
	
	this->m_CommandReAddSwitch[0] = GetPrivateProfileInt(section,"CommandReAddEnable_AL0",0,path);

	this->m_CommandReAddSwitch[1] = GetPrivateProfileInt(section,"CommandReAddEnable_AL1",0,path);

	this->m_CommandReAddSwitch[2] = GetPrivateProfileInt(section,"CommandReAddEnable_AL2",0,path);

	this->m_CommandReAddSwitch[3] = GetPrivateProfileInt(section,"CommandReAddEnable_AL3",0,path);

	GetPrivateProfileString(section,"CommandReAddSyntax","",this->m_CommandReAddSyntax,sizeof(this->m_CommandReAddSyntax),path);

	this->m_CommandAddPkSwitch[0] = GetPrivateProfileInt(section,"CommandAddPkEnable_AL0",0,path);

	this->m_CommandAddPkSwitch[1] = GetPrivateProfileInt(section,"CommandAddPkEnable_AL1",0,path);

	this->m_CommandAddPkSwitch[2] = GetPrivateProfileInt(section,"CommandAddPkEnable_AL2",0,path);

	this->m_CommandAddPkSwitch[3] = GetPrivateProfileInt(section,"CommandAddPkEnable_AL3",0,path);

	GetPrivateProfileString(section,"CommandAddPkSyntax","",this->m_CommandAddPkSyntax,sizeof(this->m_CommandAddPkSyntax),path);
	
	this->m_CommandMakeSetSwitch = GetPrivateProfileInt(section,"CommandMakeSetSwitch",0,path);

	this->m_CommandMakeSetGameMasterLevel = GetPrivateProfileInt(section,"CommandMakeSetGameMasterLevel",0,path);

	GetPrivateProfileString(section,"CommandMakeSetSyntax","",this->m_CommandMakeSetSyntax,sizeof(this->m_CommandMakeSetSyntax),path);

	this->m_CommandSpotSwitch = GetPrivateProfileInt(section, "CommandSpotSwitch", 0, path);

	this->m_CommandSpotGameMasterLevel = GetPrivateProfileInt(section, "CommandSpotGameMasterLevel", 0, path);

	GetPrivateProfileString(section, "CommandSpotSyntax", "", this->m_CommandSpotSyntax, sizeof(this->m_CommandSpotSyntax), path);

	GetPrivateProfileString(section, "CommandQuizAnswerSyntax", "", this->m_CommandQuizSyntax, sizeof(this->m_CommandQuizSyntax), path);

	this->m_CommandClearWarehouseSwitch[0] = GetPrivateProfileInt(section, "CommandClearWarehouseEnable_AL0", 0, path);

	this->m_CommandClearWarehouseSwitch[1] = GetPrivateProfileInt(section, "CommandClearWarehouseEnable_AL1", 0, path);

	this->m_CommandClearWarehouseSwitch[2] = GetPrivateProfileInt(section, "CommandClearWarehouseEnable_AL2", 0, path);
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_DLCreateSwitch = GetPrivateProfileInt(section, "DLCreateSwitch", 0, path);
	...
	this->m_ShieldGaugeRate = GetPrivateProfileInt(section,"ShieldGaugeRate",90,path);

	this->m_ShieldGaugeConstA = GetPrivateProfileInt(section,"ShieldGaugeConstA",12,path);

	this->m_ShieldGaugeConstB = GetPrivateProfileInt(section,"ShieldGaugeConstB",15,path);

	this->m_ShieldGaugeAttackRate = GetPrivateProfileInt(section,"ShieldGaugeAttackRate",2,path);
	...
	this->m_CoinsPerTimeSwitch = GetPrivateProfileInt(section,"CoinsPerTimeSwitch",0,path);

	this->m_CoinsPerTimeDelay = GetPrivateProfileInt(section,"CoinsPerTimeDelay",0,path);

	this->m_CoinsPerTimeType1[0] = GetPrivateProfileInt(section,"CoinsPerTimeType1_AL0",0,path);

	this->m_CoinsPerTimeType1[1] = GetPrivateProfileInt(section,"CoinsPerTimeType1_AL1",0,path);

	this->m_CoinsPerTimeType1[2] = GetPrivateProfileInt(section,"CoinsPerTimeType1_AL2",0,path);

	this->m_CoinsPerTimeType1[3] = GetPrivateProfileInt(section,"CoinsPerTimeType1_AL3",0,path);

	this->m_CoinsPerTimeType2[0] = GetPrivateProfileInt(section,"CoinsPerTimeType2_AL0",0,path);

	this->m_CoinsPerTimeType2[1] = GetPrivateProfileInt(section,"CoinsPerTimeType2_AL1",0,path);

	this->m_CoinsPerTimeType2[2] = GetPrivateProfileInt(section,"CoinsPerTimeType2_AL2",0,path);

	this->m_CoinsPerTimeType2[3] = GetPrivateProfileInt(section,"CoinsPerTimeType2_AL3",0,path);

	this->m_CoinsPerTimeType3[0] = GetPrivateProfileInt(section,"CoinsPerTimeType3_AL0",0,path);

	this->m_CoinsPerTimeType3[1] = GetPrivateProfileInt(section,"CoinsPerTimeType3_AL1",0,path);

	this->m_CoinsPerTimeType3[2] = GetPrivateProfileInt(section,"CoinsPerTimeType3_AL2",0,path);

	this->m_CoinsPerTimeType3[3] = GetPrivateProfileInt(section,"CoinsPerTimeType3_AL3",0,path);
...
void CServerInfo::ReadCustomInfo(char* section,char* path) // OK
{
	...
	this->m_AncientType = GetPrivateProfileInt(section,"AncientItemTapeSwitch",0,path);
...
void CServerInfo::ReadEventInfo(char* section,char* path) // OK
{
	...
	this->m_CustomQuizSwitch = GetPrivateProfileInt(section, "EventQuizSwitch", 0, path);

	GetPrivateProfileString(section,"CommandGoEventsSyntax","",this->m_CommandGoEventsSyntax,sizeof(this->m_CommandGoEventsSyntax),path);

	GetPrivateProfileString(section,"EventKillAllSyntax","",this->m_EventKillAllSyntax,sizeof(this->m_EventKillAllSyntax),path);

	GetPrivateProfileString(section,"EventRunAndCatchSyntax","",this->m_EventRunAndCatchSyntax,sizeof(this->m_EventRunAndCatchSyntax),path);

	GetPrivateProfileString(section,"EventRussianRouletteSyntax","",this->m_EventRussianRouletteSyntax,sizeof(this->m_EventRussianRouletteSyntax),path);
	...
	this->m_EventRunAndCatchSwitch			= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchSwitch",0,path) : 0;
	this->m_EventRunAndCatchTimeToEnter		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchTimeToEnter",30,path): 0;
	this->m_EventRunAndCatchMaxTime			= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchMaxTime",0,path): 0;
	this->m_EventRunAndCatchAutoReward1		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchAutoReward1",0,path): 0;
	this->m_EventRunAndCatchAutoReward2		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchAutoReward2",0,path): 0;
	this->m_EventRunAndCatchAutoReward3		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRunAndCatchAutoReward3",0,path): 0;
	
	this->m_EventRussianRouletteSwitch		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteSwitch",0,path) : 0;
	this->m_EventRussianRouletteTimeToEnter	= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteTimeToEnter",30,path) : 0;
	this->m_EventRussianRouletteMaxTime		= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteMaxTime",0,path): 0;
	this->m_EventRussianRouletteMaxPlayer	= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteMaxPlayer",0,path): 0;
	this->m_EventRussianRouletteAutoReward1	= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteAutoReward1",0,path): 0;
	this->m_EventRussianRouletteAutoReward2	= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteAutoReward2",0,path): 0;
	this->m_EventRussianRouletteAutoReward3	= (GAMESERVER_CLIENTE_UPDATE > 3) ? GetPrivateProfileInt(section,"EventRussianRouletteAutoReward3",0,path): 0;
}
