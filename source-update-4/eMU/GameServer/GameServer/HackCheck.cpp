...
void InitHackCheck() // OK
{
	...
	EncDecKey1 = (BYTE)0xA2;	//Pacote 01 - Enviado do GS para comparacao na nova funcao do Main
	EncDecKey2 = (BYTE)0x83;	//Pacote 02 - Enviado do GS para comparacao na nova funcao do Main
