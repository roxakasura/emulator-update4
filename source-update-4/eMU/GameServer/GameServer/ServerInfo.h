...
public:
	...
	//
	int m_CoinsPerTimeSwitch;
	int m_CoinsPerTimeDelay;
	int m_CoinsPerTimeType1[MAX_ACCOUNT_LEVEL];
	int m_CoinsPerTimeType2[MAX_ACCOUNT_LEVEL];
	int m_CoinsPerTimeType3[MAX_ACCOUNT_LEVEL];
	//
	...
	char m_CommandGoEventsSyntax[32];
	char m_EventKillAllSyntax[32];
	char m_EventRunAndCatchSyntax[32];
	char m_EventRussianRouletteSyntax[32];
	//Event Skill All
	...
	int m_CommandClearInventorySwitch[MAX_ACCOUNT_LEVEL];
	char m_CommandClearInvSyntax[32];
	int m_CommandReAddSwitch[MAX_ACCOUNT_LEVEL];
	char m_CommandReAddSyntax[32];
	int m_CommandMakeSetSwitch;
	int m_CommandMakeSetGameMasterLevel;
	char m_CommandMakeSetSyntax[32];
	int m_CommandAddPkSwitch[MAX_ACCOUNT_LEVEL];
	char m_CommandAddPkSyntax[32];
	int m_CommandSpotSwitch;
	int m_CommandSpotGameMasterLevel;
	char m_CommandSpotSyntax[32];
	char m_CommandQuizSyntax[32];
	//
	int m_CommandClearWarehouseSwitch[MAX_ACCOUNT_LEVEL];
	char m_CommandClearWarehouseSyntax[32];
	//comandos - strings
	char m_CommandMoveSyntax[32];
	char m_CommandPostSyntax[32];
	char m_CommandAddPointStrenghtSyntax[32];
	char m_CommandAddPointAgilitySyntax[32];
	char m_CommandAddPointVitalitySyntax[32];
	char m_CommandAddPointEnergySyntax[32];
	char m_CommandAddPointCommandSyntax[32];
	char m_CommandPKClearSyntax[32];
	char m_CommandMoneySyntax[32];
	char m_CommandChangeSyntax[32];
	char m_CommandWareSyntax[32];
	char m_CommandResetSyntax[32];
	char m_CommandMasterResetSyntax[32];
	char m_CommandGMMoveSyntax[32];
	char m_CommandGMPostSyntax[32];
	char m_CommandTrackSyntax[32];
	char m_CommandTraceSyntax[32];
	char m_CommandDisconnectSyntax[32];
	char m_CommandFireworksSyntax[32];
	char m_CommandMakeSyntax[32];
	char m_CommandSkinSyntax[32];
	char m_CommandSetMoneySyntax[32];
	char m_CommandNoticeSyntax[32];
	char m_CommandHideSyntax[32];
	char m_CommandGuildWarSyntax[32];
	char m_CommandBattleSoccerSyntax[32];
	char m_CommandRequestSyntax[32];
	int m_CommandRequestSwitch[MAX_ACCOUNT_LEVEL];
