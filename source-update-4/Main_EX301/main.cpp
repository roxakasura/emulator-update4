...
extern "C" _declspec(dllexport) void Init()
{
	...
	SetCompleteHook(0xE9,0x0066271F,&Optimize);
	...
	SetByte(0x0064903C,0xEB); // Crack (GameGuard) Accent
	SetByte(0x0064908A, 0xE9); // Crack (GameGuard)  Accent
	SetByte(0x00675D0A,0xEB); // Crack (ResourceGuard)
	SetByte(0x004A9367,0xE9); // Age Image
	SetByte(0x004A9368+1,0x02); // Age Image
	SetByte(0x004A9369+2,0x01); // Age Image
	SetByte(0x004A9367+3,0x00); // Age Image
	SetByte(0x004A9367+4,0x00); // Age Image
	SetByte(0x004A95EC,0xC3); // Age Image
	SetByte(0x00533306, 0xEB); // Corrupted Filter.bmd 
	SetByte(0x00496F7A, 0xEB); // Corrupted ItemSetType.bmd
	SetByte(0x004971AF, 0xEB); // Corrupted ItemSetOption.bmd
	SetByte(0x004F8B3B, 0xEB); // Ctrl Fix
	SetByte(0x004F8B49, 0x02); // Ctrl Fix
	SetByte(0x0050CFB8, 0xC3); //Fix 1.04J Recuo
	SetByte(0x00648C71,0xEB); // Multi Instance
	SetByte(0x00661EA3+1,0); //remove website
