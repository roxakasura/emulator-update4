...
void CAddons::Load()
{
	...
	SetCompleteHook(0xE9, 0x005A20C0,this->ExperienceSettings);
}
...
//	Console.Write(Experiencia2,0,1);
	...
	if(pCursorX  >= 219.0 && pCursorX < 421.0 &&  pCursorY >= 439.0 && pCursorY < 445.0 )
	{
		...
		sprintf(Experiencia,"Exp : %d/%d",gUser.m_Player.Experience,gUser.m_Player.NextExperience);
