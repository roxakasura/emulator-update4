...
void InitHackCheck() // OK
{
	...
	HookRecv = *(WSRECV*)(0x007565D4);		// Offsets EncDecKey Recv Hook 1.04j

	HookSend = *(WSSEND*)(0x007565E4);		// Offsets EncDecKey Send Hook 1.04j

	SetDword(0x007565D4, (DWORD)&MyRecv);	// Funcao EncDecKey Recv Hook 1.04j

	SetDword(0x007565E4, (DWORD)&MySend);	// Funcao EncDecKey Send Hook 1.04j
}
