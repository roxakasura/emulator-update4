...
#define MAIN_CONNECTION_STATUS			0x07B06BD0  // 1.04j  7B06BD0 ok 
#define MAIN_SCREEN_STATE				0x0077EBAC  // 1.04j 0077EBAC
#define MAIN_CHARACTER_STRUCT			0x76C1D90 // 1.02r 74D2C58 ok 
#define MAIN_VIEWPORT_STRUCT			0x7469838 // 1.02r  74D2B2C ok
#define MAIN_PACKET_SERIAL				0x07B06BCB // 1.04j 7B06BCB ok
...
#define MAIN_PARTY_MEMBER_COUNT			0x07672E50 // 1.04j 7672E50 ok
#define MAIN_WINDOW						0x00647CC2 //ou esse 0077EBAC

#define ProtocolCore ((BOOL(*)(DWORD,BYTE*,DWORD,DWORD))0x4FFE40) // 1.02r 0069C3C0  ok
