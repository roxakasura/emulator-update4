...
void InitHackCheck() // OK
{
	...
	HookRecv = *(WSRECV*)(0x006E8588);		// Offsets EncDecKey Recv Hook 1.02r

	HookSend = *(WSSEND*)(0x006E8598);		// Offsets EncDecKey Send Hook 1.02r

	SetDword(0x006E8588, (DWORD)&MyRecv);	// Funcao EncDecKey Recv Hook 1.02r

	SetDword(0x006E8598, (DWORD)&MySend);	// Funcao EncDecKey Send Hook 1.02r
}
